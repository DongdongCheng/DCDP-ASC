function [icl,cl,NCLUST ] = DP_center(Y1, dist,rho )
...
% title ('LORE Clustering Result','FontSize',15.0)
% xlabel ('X')
% ylabel ('Y')
% for i=1:ND
%  A(i,1)=0.;
...
% plot(Y1(icl,1),Y1(icl,2),'o','MarkerSize',6,'MarkerFaceColor','r','MarkerEdgeColor','r');
% toc;
% %for i=1:ND
% %   if (halo(i)>0)
